...
<head>
        ...
        <title>Hyumilectro Enterprise</title>
        ...
        <?php
            ...
            if($page!='' && file_exists("middlepage/".$page.'.php'))
            {
                if($page=="home")
                {
                    ...
                    include("middlepage/home.php");
                }
                else
                {
                    //include('template/header.php');
                    include('template/navigation1.php');
 ...
 <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDSLSFRa0DyBj9VGzT7GM6SFbSMcG0YNBM"></script> 
        ...
        <script type="text/javascript">
            ...
            function init() {
                var mapOptions = {
                    zoom: 11,
                    center: new google.maps.LatLng(22.9978276, 72.6461323), // New York
